...
* They will also use the [Render Deployment Guide](https://coding-boot-camp.github.io/full-stack/render/render-deployment-guide).
...
In the next module, students will work with PostgreSQL databases. They will need to install PostgreSQL Server on their machine prior to class. Be sure to provide students with the [PostgreSQL installation guide on The Full-Stack Blog](https://coding-boot-camp.github.io/full-stack/postgresql/postgresql-installation-guide) by the end of this module to minimize installation time next module.
...
* [11.3 Lesson Plan](./03-Day_Router-Middleware-Render/11.3-LESSON-PLAN.md)
...
* [Render documentation on getting started with Node.js and Express.js](https://docs.render.com/deploy-node-express-app)
